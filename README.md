## mrpt2 (humble) - 2.13.0-1

The packages in the `mrpt2` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble mrpt2` on `Tue, 04 Jun 2024 06:47:08 -0000`
...
## mrpt2 (rolling) - 2.12.2-1

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r rolling -y mrpt2` on `Tue, 23 Apr 2024 00:05:47 -0000`
...
The packages in the `mrpt2` repository were released into the `iron` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r iron -y mrpt2` on `Mon, 22 Apr 2024 23:58:52 -0000`
...
The packages in the `mrpt2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling mrpt2` on `Thu, 05 May 2022 19:54:30 -0000`
...
## mrpt2 (humble) - 2.4.3-1

The packages in the `mrpt2` repository were released into the `humble` distro by running `/home/steven/osrf/bloom/.direnv/python-3.10.4/bin/bloom-release -r humble -n mrpt2` on `Wed, 20 Apr 2022 22:50:38 -0000`
...
## mrpt2 (rolling) - 2.4.3-1

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release mrpt2 --rosdistro rolling` on `Sat, 05 Mar 2022 07:40:43 -0000`
...
## mrpt2 (galactic) - 2.4.3-1

The packages in the `mrpt2` repository were released into the `galactic` distro by running `/usr/bin/bloom-release mrpt2 --rosdistro galactic` on `Tue, 01 Mar 2022 11:43:47 -0000`
...
## mrpt2 (rolling) - 2.1.3-2

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling mrpt2` on `Sat, 24 Oct 2020 14:23:12 -0000`
...
## mrpt2 (rolling) - 2.1.3-1

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling mrpt2` on `Thu, 22 Oct 2020 21:16:47 -0000`
...
The packages in the `mrpt2` repository were released into the `foxy` distro by running `/usr/bin/bloom-release mrpt2 --rosdistro foxy` on `Thu, 03 Sep 2020 05:34:16 -0000`
